...
public class LendRetCmp extends Composite {
	private Text text;
	private Text text_1;
	private Text text_2;
	private Text text_3;
	 ...
	 * @param style
	 */
	public LendRetCmp(Composite parent, int style) {
		super(parent, style);
		...
		fd_lblNewLabel.bottom = new FormAttachment(label_3, 35, SWT.BOTTOM);
		fd_lblNewLabel.top = new FormAttachment(label_3, 18);
		fd_lblNewLabel.left = new FormAttachment(label, 0, SWT.LEFT);
		fd_lblNewLabel.right = new FormAttachment(0, 83);
		lblNewLabel.setLayoutData(fd_lblNewLabel);
		lblNewLabel.setText("借出时间:");
		...
		fd_text_4.top = new FormAttachment(text_3, 12);
		fd_text_4.left = new FormAttachment(lblNewLabel, 10);
